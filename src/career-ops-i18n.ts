...
export const careerOpsContent = {
  es: {
    ...
    header: {
      kicker: 'Case Study: De proyecto personal a 43.7K+ stars',
      h1: 'Career-Ops: Cómo un Agente IA Automatizó Mi Búsqueda de Empleo',
      subtitle: 'Construí un sistema multi-agente para automatizar mi búsqueda de empleo. Funcionó: ahora soy Head of Applied AI. Luego lo abrí como open source y se hizo viral — 43.7K+ estrellas en GitHub.',
    ...
    sections: {
      intro: {
        hook: 'Construí un sistema de IA para buscar trabajo. Funcionó — ahora soy Head of Applied AI. Luego lo publiqué en GitHub y explotó: 43.7K+ estrellas, viral, artículos en Francia, China y Corea. La primera semana buscando trabajo en IA lo hice todo manual. La segunda semana ya no aplicaba — estaba construyendo Career-Ops.',
      ...
      lessons: {
        ...
        items: [
          ...
          },
          {
            ...
            detail: 'Career-Ops fue privado mientras lo usaba. Cuando conseguí el trabajo, lo publiqué. En una semana tenía 43.7K estrellas. La lección: el mejor momento para abrir un proyecto es cuando ya demostró su valor en producción real.',
          },
          {
  ...
  en: {
    ...
    header: {
      kicker: 'Case Study: From side project to 43.7K+ stars',
      h1: 'Career-Ops: How I Built an AI Job Search System That Got Me Hired',
      subtitle: 'I built a multi-agent system to automate my job search. It worked — I am now Head of Applied AI. Then I open-sourced it and it went viral — 43.7K+ GitHub stars.',
    ...
    sections: {
      intro: {
        hook: 'I built an AI system to search for a job. It worked — I am now Head of Applied AI. Then I published it on GitHub and it exploded: 43.7K+ stars, viral, articles in France, China, and Korea. Week one of my AI job search was all manual. By week two I had stopped applying — I was building Career-Ops.',
      ...
      lessons: {
        ...
        items: [
          ...
          },
          {
            ...
            detail: 'Career-Ops was private while I was using it. When I got the job, I published it. One week later it had 43.7K stars. The lesson: the best time to open-source a project is when it has already proven its value in real production.',
          },
          {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'I did — Santiago Fernández de Valderrama (santifer). I built it for my own AI job search after spending 16 years founding and selling a phone repair business. The system evaluated 631 offers and helped me land my current role as Head of Applied AI. When I no longer needed it, I published it as open source. In one week it reached 43.7K+ GitHub stars. The Discord community is now 2,700+ people: discord.gg/8pRpHETxa4',
        },
      ],
    },
  },
