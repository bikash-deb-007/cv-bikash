...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  return (
    <ArticleLayout lang={lang}>
      <FloatingToc />
      <ArticleHeader editorId="hero-header" lang={lang} kicker={t.header.kicker} h1={t.header.h1} subtitle={t.header.subtitle} date={t.header.date} dateISO="2026-02-25" dateModifiedISO="2026-05-06" readingTime={t.readingTime} />
      ...
      <GitHubRepoBadge repo="santifer/jacobo-workflows" stars="135" forks="44" lang={lang} />
